...
- Other controls are mentioned on screen.
- Unit Tests:
    1. Launch the project in the editor.
    2. Launch the UnrealFrontEnd (~/UE_4.17/Binaries/Win64/UnrealFrontEnd.exe).
    3. Select an active session, then run the EAE_6900 unit tests under the automation tab.
